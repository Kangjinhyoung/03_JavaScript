...
// id가 "test1a" 인 요소를 얻어와 "test1a" 변수에 저장을 하겠다
...
test1a.onclick = function() {
  // 고전 이벤트 모델 - 이벤트 핸들러 내에서 this : 클릭된 요소를 보여줌
  console.log(this);
  alert("확인 버튼 클릭됨");
}
...
// 필드(변수)로 하나씩 존재한다 -> 변수는 마지막으로 대입된 값으로 덮어 씌워진다
...
test2.addEventListener("click", function() {
  ...
  */
  ...
  // 4) 투명도가 음수가 되었을 때 다시 1로 변경하는 코드
...
// - 요소.addEventListener()는 요소에게만 사용 가능하다.
