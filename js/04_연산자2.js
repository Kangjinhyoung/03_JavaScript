...
function check1() {
  ...
  console.log ( `${ num1 } == ${ num3 } => ${ num1 == num3 }` ); // 100 == 999 => false
  console.log ( `${ num1 } != ${ num3 } => ${ num1 != num3 }` ); // 100 != 999 => true
  // 동등 비교 ( 숫자 == 문자열 )
  console.log ( `${ num1 } == "${ str1 }" => ${ num1 == str1 }` ); // 100 == "100" => true
  // 문자열끼리 비교
  console.log ( `"${ str1 }" == "${ str2 }" => ${ str1 == str2 }` ); // "100" == "100" => true
  console.log ( `"${ str1 }" == "${ str3 }" => ${ str1 == str3 }` ); // "100" == "999" => false
  console.log ( `"${ str1 }" != "${ str3 }" => ${ str1 != str3 }` ); // "100" != "999" => true
  ...
  console.log ( `${ num1 } !== ${ num3 } => ${ num1 !== num3 }` ); // 100 !== 999 => true
  // 동일 비교 ( 숫자 === 문자열 )
  console.log ( `${ num1 } === "${ str1 }" => ${ num1 === str1 }` ); // 100 === "100" => false
  ...
  // 초과 / 미만
  console.log ( `${ num1 } > ${ num2 } --> ${ num1 > num2 }` ); // 100 > 100 --> false
  console.log ( `${ num3 } > ${ num2 } --> ${ num3 > num2 }` ); // 999 > 100 --> true
  // 이상 / 이하
  console.log ( `${ num1 } >= ${ num2 } --> ${ num1 >= num2 }` ); // 100 >= 100 --> true
...
/* 
  ...
  OR  ( || ) : 둘 다 false 인 경우에만 false ( 나머진 true )
*/
